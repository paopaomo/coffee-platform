...
(function($) {
    ...
    $.ajax({
        type: "GET",
        url: "http://www.easy-mock.com/mock/598ac5c6a1d30433d85ad129/coffee-shop/list/coffee-shop/list",
        dataType: "json",
        success: function (data) {//data:responseText
            ...
            touchFunc($(".searchBtn")[0],"click",function () {
                var name = encodeURI(encodeURI($("#searchContent").val()));
                console.log(name);
            })
